...
| pageTitle                | {String\|object}   | "React App" | 页面的 title，string 时表示全部页面的 title，也可以使用 object 分页面配置                                                                                                                                                                                                                   |
| defaultTitle             | String             | "React App" | 页面默认的 title，pageTitle 为 Object 时匹配不到时使用。                                                                                                                                                                                                                                    |
